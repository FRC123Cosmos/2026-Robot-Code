...
public class LedSubsystem extends SubsystemBase {            
    ...
    private static double blinkLastChangeTime = 0;
    private static boolean blinkIsOn = true;
    private static final double BLINK_INTERVAL_FAST = 0.3;
    ...
    public static void blinkAllianceSolid() {
        ...
        animationTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (currentTime - blinkLastChangeTime >= BLINK_INTERVAL) {
                    blinkIsOn = !blinkIsOn;
    ...
    public static void blinkYellowFast() {
        // Stop any existing animation
        if (animationTimer != null) {
            animationTimer.cancel();
            animationTimer = null;
    ...
    public static void blinkAllianceSolidSlow() {
        ...
        animationTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                // Switch phases if enough time has passed
                if (currentTime - blinkLastChangeTime >= ALLIANCE_BLINK_INTERVAL_SLOW) {
                    blinkIsOn = !blinkIsOn;
                    blinkLastChangeTime = currentTime;
                }
